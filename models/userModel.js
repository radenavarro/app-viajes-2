...
const DatosUser = MysqlConnection.define('users', {
    id: {type: Sequelize.INTEGER, allowNull: false, autoIncrement: true, primaryKey: true},
    usuario: {type: Sequelize.STRING(45)},
    email: {type: Sequelize.STRING(45)},
    password: {type: Sequelize.STRING(80)},
    hash: {type: Sequelize.STRING(80)},
    permisos: {type: Sequelize.BOOLEAN}
});
